...
sliders.forEach(slider => {
    ...
    const image1 = container.querySelector(".fade-1");
    const image2 = container.querySelector(".fade-2");
    const image3 = container.querySelector(".fade-3");
    // more image
    ...
    if (value < 50) {
        image2.style.opacity = value / 50;
        image3.style.opacity = 0;
        // more image
    } else {
        image2.style.opacity = 1;
        image3.style.opacity = (value - 50) / 50;
        // more image
    }
